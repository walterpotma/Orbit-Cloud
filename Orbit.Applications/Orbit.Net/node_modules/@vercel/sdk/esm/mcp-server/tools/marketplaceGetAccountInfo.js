...
export const tool$marketplaceGetAccountInfo = {
...
Fetches the best account or user’s contact info`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await marketplaceGetAccountInfo(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
