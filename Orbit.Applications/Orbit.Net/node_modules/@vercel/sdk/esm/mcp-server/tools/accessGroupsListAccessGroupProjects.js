...
export const tool$accessGroupsListAccessGroupProjects = {
...
List projects of an access group`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await accessGroupsListAccessGroupProjects(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
