...
export const tool$edgeConfigCreateEdgeConfigToken = {
...
Adds a token to an existing Edge Config.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await edgeConfigCreateEdgeConfigToken(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
