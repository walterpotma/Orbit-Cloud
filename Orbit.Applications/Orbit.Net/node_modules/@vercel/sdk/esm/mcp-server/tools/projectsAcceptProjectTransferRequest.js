...
export const tool$projectsAcceptProjectTransferRequest = {
...
Accept a project transfer request initated by another team. <br/> The \`code\` is generated using the \`POST /projects/:idOrName/transfer-request\` endpoint.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await projectsAcceptProjectTransferRequest(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
