...
// Definição do Tipo baseado no seu JSON
type RegistryImage = {
  name: string;
  tags: string[];
};
      ...
      <div className="w-full max-w-6xl mx-auto">
        ...
        {!isLoading && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {artifacts.map((repo) => (
              ...
              >
                {/* Cabeçalho do Card (Nome do Repo) */}
        ...
        {!isLoading && artifacts.length === 0 && (
          <div className="text-center py-20 border border-dashed border-zinc-800 rounded-xl">
            ...
            <h3 className="text-lg font-medium text-zinc-300">Nenhum artefato encontrado</h3>
            <p className="text-zinc-500">Execute um Assembly (Build) para gerar sua primeira imagem.</p>
          </div>
        )}
      </div>
    </div>
