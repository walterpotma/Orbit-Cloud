...
import NavigationResponsive from "@/components/layout/navigation-responsive";
            ...
            <UserProvider>
                ...
                >
                    <div className="w-full h-dvh flex flex-col-reverse lg:flex-row overflow-y-auto">
                        ...
                        <main className="flex-1 h-full relative overflow-y-auto custom-scroll">
                            {children}
                        </main>

                    </div>

                    <div className="hidden sm:flex fixed bottom-4 right-4 z-50 pointer-events-none select-none">
