...
export default function Button({ text, icon, active, onClick, className, open }: ButtonProps) {
    ...
    return (
        <button onClick={onClick} className={`w-full py-4 flex ${open ? 'justify-center px-2' : 'justify-start px-10'} items-center cursor-pointer hover:bg-slate-800 hover:text-blue-500 hover:border-l-2 border-blue-500 ${activeStyles} ${className}`}>
