...
export const tool$environmentCreateCustomEnvironment = {
...
Creates a custom environment for the current project. Cannot be named 'Production' or 'Preview'.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await environmentCreateCustomEnvironment(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
