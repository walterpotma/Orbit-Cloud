...
export const tool$environmentGetCustomEnvironment = {
...
Retrieve a custom environment for the project. Must not be named 'Production' or 'Preview'.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await environmentGetCustomEnvironment(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
