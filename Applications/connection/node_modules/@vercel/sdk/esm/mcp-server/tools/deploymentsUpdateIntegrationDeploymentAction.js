...
export const tool$deploymentsUpdateIntegrationDeploymentAction = {
...
Updates the deployment integration action for the specified integration installation`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await deploymentsUpdateIntegrationDeploymentAction(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
