...
export const tool$teamsRequestAccessToTeam = {
...
Request access to a team as a member. An owner has to approve the request. Only 10 users can request access to a team at the same time.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await teamsRequestAccessToTeam(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
